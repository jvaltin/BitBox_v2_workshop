...
typedef struct {
    ...
    __IM  uint32_t
    MVFR2;                  /*!< Offset: 0x248 (R/ )  Media and VFP Feature Register 1 */
...
{
    if ((int32_t)(IRQn) >= 0) {
        return ((uint32_t)(((NVIC->ISER[(((uint32_t)(int32_t)IRQn) >> 5UL)] & (1UL << (((
...
{
    if ((int32_t)(IRQn) >= 0) {
        return ((uint32_t)(((NVIC->ITNS[(((uint32_t)(int32_t)IRQn) >> 5UL)] & (1UL << (((
                                 uint32_t)(int32_t)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    } else {
        return (0U);
    }
...
{
    if ((int32_t)(IRQn) >= 0) {
        NVIC->ITNS[(((uint32_t)(int32_t)IRQn) >> 5UL)] |=  ((uint32_t)(1UL << (((uint32_t)(
                    int32_t)IRQn) & 0x1FUL)));
        return ((uint32_t)(((NVIC->ITNS[(((uint32_t)(int32_t)IRQn) >> 5UL)] & (1UL << (((
                                 uint32_t)(int32_t)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    } else {
...
{
    if ((int32_t)(IRQn) >= 0) {
        NVIC->IPR[((uint32_t)(int32_t)IRQn)]               = (uint8_t)((priority <<
...
__STATIC_INLINE uint32_t __NVIC_GetPriority(IRQn_Type IRQn)
{
    ...
    if ((int32_t)(IRQn) >= 0) {
        return (((uint32_t)NVIC->IPR[((uint32_t)(int32_t)IRQn)]               >>
                 (8U - __NVIC_PRIO_BITS)));
    } else {
        ...
        uint32_t PreemptPriority, uint32_t SubPriority)
{
    ...
    SubPriorityBits     = ((PriorityGroupTmp + (uint32_t)(__NVIC_PRIO_BITS)) <
                           (uint32_t)7UL) ? (uint32_t)0UL : (uint32_t)((PriorityGroupTmp - 7UL) + (uint32_t)(
                                       __NVIC_PRIO_BITS));
...
{
    if ((int32_t)(IRQn) >= 0) {
        NVIC_NS->ISER[(((uint32_t)(int32_t)IRQn) >> 5UL)] = (uint32_t)(1UL << (((uint32_t)(
                    int32_t)IRQn) & 0x1FUL));
    }
}
...
{
    if ((int32_t)(IRQn) >= 0) {
        return ((uint32_t)(((NVIC_NS->ISER[(((uint32_t)(int32_t)IRQn) >> 5UL)] & (1UL << (((
                                 uint32_t)(int32_t)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    } else {
        return (0U);
    }
...
{
    if ((int32_t)(IRQn) >= 0) {
        NVIC_NS->ICER[(((uint32_t)(int32_t)IRQn) >> 5UL)] = (uint32_t)(1UL << (((uint32_t)(
                    int32_t)IRQn) & 0x1FUL));
    }
}
...
{
    if ((int32_t)(IRQn) >= 0) {
        return ((uint32_t)(((NVIC_NS->ISPR[(((uint32_t)(int32_t)IRQn) >> 5UL)] & (1UL << (((
                                 uint32_t)(int32_t)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
}
...
{
    if ((int32_t)(IRQn) >= 0) {
        NVIC_NS->ISPR[(((uint32_t)(int32_t)IRQn) >> 5UL)] = (uint32_t)(1UL << (((uint32_t)(
                    int32_t)IRQn) & 0x1FUL));
    }
}
...
{
    if ((int32_t)(IRQn) >= 0) {
        NVIC_NS->ICPR[(((uint32_t)(int32_t)IRQn) >> 5UL)] = (uint32_t)(1UL << (((uint32_t)(
                    int32_t)IRQn) & 0x1FUL));
    }
}
...
{
    if ((int32_t)(IRQn) >= 0) {
        return ((uint32_t)(((NVIC_NS->IABR[(((uint32_t)(int32_t)IRQn) >> 5UL)] & (1UL << (((
                                 uint32_t)(int32_t)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    } else {
        return (0U);
    }
...
{
    if ((int32_t)(IRQn) >= 0) {
        NVIC_NS->IPR[((uint32_t)(int32_t)IRQn)]               = (uint8_t)((priority <<
                (8U - __NVIC_PRIO_BITS)) & (uint32_t)0xFFUL);
    } else {
        SCB_NS->SHPR[(((uint32_t)(int32_t)IRQn) & 0xFUL) - 4UL] = (uint8_t)((priority <<
                (8U - __NVIC_PRIO_BITS)) & (uint32_t)0xFFUL);
    }
}
...
__STATIC_INLINE uint32_t TZ_NVIC_GetPriority_NS(IRQn_Type IRQn)
{
    ...
    if ((int32_t)(IRQn) >= 0) {
        return (((uint32_t)NVIC_NS->IPR[((uint32_t)(int32_t)IRQn)]               >>
                 (8U - __NVIC_PRIO_BITS)));
    } else {
        return (((uint32_t)SCB_NS->SHPR[(((uint32_t)(int32_t)IRQn) & 0xFUL) - 4UL] >>
                 (8U - __NVIC_PRIO_BITS)));
    }
}
#endif /*  defined (__ARM_FEATURE_CMSE) &&(__ARM_FEATURE_CMSE == 3U) */
...
__STATIC_INLINE uint32_t TZ_SysTick_Config_NS(uint32_t ticks)
{
    ...
    SysTick_NS->LOAD  = (uint32_t)(ticks -
                                   1UL);                            /* set reload register */
