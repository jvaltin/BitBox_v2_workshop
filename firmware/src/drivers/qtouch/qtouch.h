...
This file is part of QTouch Modular Library Release 5.0 example application.
...
#define NODE_0_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(26), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
#define NODE_1_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(27), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
#define NODE_2_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(28), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
#define NODE_3_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(29), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
#define NODE_4_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(30), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
#define NODE_5_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(31), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
#define NODE_6_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(20), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
#define NODE_7_PARAMS                                                                                                  \
    {                                                                                                                  \
        X_NONE, Y_LINE(21), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_1), NODE_GAIN(GAIN_8, GAIN_2), FILTER_LEVEL_16      \
    }
...
#define KEY_0_PARAMS                                                                                                   \
    {                                                                                                                  \
        45, HYST_50, NO_AKS_GROUP                                                                                    \
    }
#define KEY_1_PARAMS                                                                                                   \
    {                                                                                                                  \
        50, HYST_50, NO_AKS_GROUP                                                                                    \
    }
#define KEY_2_PARAMS                                                                                                   \
    {                                                                                                                  \
        50, HYST_50, NO_AKS_GROUP                                                                                    \
 ...
 * touch_contact_min_threshold}
 * Configuring contact_min_threshold:
 * By default, contact_min_threshold parameter should be set equal to threshold value of the underlying keys.
 * Then the parameter has to be tuned based on the actual contact size of the touch when moved over the scroller.
 * The contact size of the moving touch can be observed from "contact_size" parameter on scroller runtime data
 * structure.
 */
#define SCROLLER_0_PARAMS                                                                                              \
    {                                                                                                                  \
        SCROLLER_TYPE_SLIDER, 4, 4, SCR_RESOL_DEADBAND(8, 5), 4, 20                                                    \
    }
#define SCROLLER_1_PARAMS                                                                                              \
    {                                                                                                                  \
        SCROLLER_TYPE_SLIDER, 0, 4, SCR_RESOL_DEADBAND(8, 5), 4, 30                                                    \
    }
