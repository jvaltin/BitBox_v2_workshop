 ...
 */
static void CRYPTOGRAPHY_0_init(void)
{
	hri_mclk_set_APBCMASK_AES_bit(MCLK);
	aes_sync_init(&CRYPTOGRAPHY_0, AES);
}

static void HASH_ALGORITHM_0_CLOCK_init(void)
{
 ...
 */
static void HASH_ALGORITHM_0_init(void)
{
...
static void SPI_1_PORT_init(void)
{
...
static void SPI_1_CLOCK_init(void)
{
...
static void SPI_0_PORT_init(void)
{
...
static void SPI_0_CLOCK_init(void)
{
...
static void I2C_0_PORT_init(void)
{
	...
	gpio_set_pin_pull_mode(PIN_I2C_SDA,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_pull_mode(PIN_I2C_SCL,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
...
static void MCI_0_PORT_init(void)
{
...
static void MCI_0_CLOCK_init(void)
{
...
static void RAND_0_CLOCK_init(void)
{
	hri_mclk_set_APBCMASK_TRNG_bit(MCLK);
}

static void RAND_0_init(void)
{
	RAND_0_CLOCK_init();
...
static void USB_0_PORT_init(void)
{
...
static void USB_0_CLOCK_init(void)
{
...
void system_init(void)
{
    ...
    gpio_set_pin_direction(PIN_ATAES_CS, GPIO_DIRECTION_OUT);
	gpio_set_pin_level(PIN_ATAES_CS, PIN_HIGH);
	gpio_set_pin_function(PIN_ATAES_CS, GPIO_PIN_FUNCTION_OFF);
	...
	gpio_set_pin_direction(PIN_NU1, GPIO_DIRECTION_OUT);
	gpio_set_pin_level(PIN_NU1, PIN_LOW);
	gpio_set_pin_function(PIN_NU1, GPIO_PIN_FUNCTION_OFF);

	gpio_set_pin_direction(PIN_NU2, GPIO_DIRECTION_IN);
	gpio_set_pin_pull_mode(PIN_NU2, GPIO_PULL_UP);
	gpio_set_pin_function(PIN_NU2, GPIO_PIN_FUNCTION_OFF);
