...
void UG_MeasureString( UG_S16 x, UG_S16 y, UG_S16 *xout, char *str);
...
/* Button functions */
UG_RESULT UG_ButtonCreate( UG_WINDOW *wnd, UG_BUTTON *btn, UG_U8 id, UG_S16 xs, UG_S16 ys,
                           UG_S16 xe, UG_S16 ye );
...
/* Checkbox functions */
UG_RESULT UG_CheckboxCreate( UG_WINDOW *wnd, UG_CHECKBOX *btn, UG_U8 id, UG_S16 xs,
